...
修改部分
"""
def generate_video(input_path='val_same/mother_wx.mp4'):
    filehead = input_path.split('/')[-1]
    output_path = "val_some/" + "out-" + filehead
...
generate_video(input_path='val_some/mother_wx.mp4')
