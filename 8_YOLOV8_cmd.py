...
YOLO V8 命令行运行模板
yolo    task=detect         mode=train                      model=yolov8[n/s/m/l/x].pt              source=0    decive=0/cpu    [show是否实时展示在屏幕上]
        classify            predict                         yolov8[n/s/m/l/x]-cls.pt                source=0    decive=0/cpu
        segment(实力分割)   val(评估模型,需要传入yaml文件)    yolov8[n/s/m/l/x]-seg.pt                source=0    decive=0/cpu
